...
public:
    ...
    Data_Reader_SIP data_reader_sip_service;
...
TEST_F(DataReaderSIPGTest, get_all_checkin_bundles_when_not_empty)
{
    ...
    vector<Checkin_Bundle> given_checkin_bundles = this->data_reader_sip_service
...
TEST_F(DataReaderSIPGTest, get_checkin_bundles_when_empty)
{
    ...
    vector<Checkin_Bundle> given_checkin_bundles = this->data_reader_sip_service.get_all_checkin_bundles();
